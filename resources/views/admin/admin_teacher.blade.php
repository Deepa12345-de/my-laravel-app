    ...
    <div class="sidebar bg-darkblue position-fixed" id="sidebar">
        <ul class="nav flex-column p-3">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" href="#"style="display:inline-block">Teachers Details</a>
            </li>
            <li class="nav-item">
            <span class="fa fa-layer-group"style="display:inline-block"></span>
                <a class="nav-link" href="#"style="display:inline-block">Courses Details</a>
            </li>
            <li class="nav-item">
            <span class="fa fa-money-bill"style="display:inline-block"></span>
                <a class="nav-link" href="#"style="display:inline-block">Fees Details</a>
            </li>
            <li class="nav-item">
            <span class="fa fa-file-alt"style="display:inline-block"></span>
                <a class="nav-link" href="#"style="display:inline-block">Reports Details</a>
            </li>
        </ul>
    </div>
